...
export function PrescreeningForm() {
  ...
  return (
    <Page>
      ...
      <p className={styles.body}>Please answer the following questions about your experience as an Interior Designer. 
        Based on your responses, we will automatically direct you 
        into the appropriate pathway. View more information about 
        the pathways here. 
      </p>  
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
        <p className={styles.question}>1. Please select the appropriate amount of experience you currently have.</p>
        
        <input type="radio" id="op11" name="question1" />
        <label htmlFor="op11">5+ years of Diversified Design Experience and/or 40+ Core Units</label>
        
        <br></br>

        <input type="radio" id="op12" name="question1" />
        <label htmlFor="op12">I do not have 5 years of Diversified Design Experience 
        and/or 40+ Core Units but am in the process of completing one of these two 
        and will do within a year from today.  
        </label>

        <br></br>

        <input type="radio" id="op13" name="question1" />
        <label htmlFor="op13">I do not have 5 years of Diversified Design Experience 
        or have 40+ Core Units and will not complete at least one of these two 
        requirements within a year from today.
        </label>
        </div>

        <div>
        <p className={styles.question}>  
        2. If you have passed any of the following qualifying National Interior Design Exams, please indicate so      
        ...
        <label htmlFor="op11">Yes</label>
        
        <br></br>

        <input type="radio" id="op22" name="question2" />
        <label htmlFor="op12">No</label>
