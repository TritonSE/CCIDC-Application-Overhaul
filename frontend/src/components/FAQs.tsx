  ...
  return (
    <>
      ...
      <div className={styles.FaqsContainer}>
        ...
        ></hr>
        <Accordion
          title="Why should I become a CID?"
          ...
          content={
            <>
              <p>
                ...
                confidence. They are accredited for professionalism, mandated to adhere to the{" "}
          ...
          content={
            <>
              ...
              <ol className={styles.olist}>
                ...
                <li>
                  Pay with credit card or check to CCIDC for the: one-time-non-refundable
                  application and processing fee. IDEX® California Exam fee, and testing center
                  fee.
                </li>
              </ol>
            </>
          ...
          content={
            <>
              <p>
                ...
                to see if you received an email from CCIDC or{" "}
        ...
        ></Accordion>
        <Accordion
          title="Who can refer themselves as CID"
          toggleAll={expandAllCertificationInfo}
          content={
            <>
              <p>
                ...
                this designation without complying with{" "}
        ...
        <Accordion
          ...
          content={
            <>
              <p>
                Certified Interior Designer (CID) is the exclusive legally recognizNOTE: There will
                be a $50.00 charge for returned checks and for $25.00 Returned Credit Card
                transaction fees. Total Fees with application (Includes Application Fee + IDEX Exam
                Fee + Testing Center Fee)*:<br></br>Path 1 & Path 2: $700 Total* <br></br>Path 3 &
                Path 4: $600 Total* <br></br>Total Bi-annual Certification Fees<br></br> Due after
                passing exam and compliance approval: <br></br> All candidates $275-300ed title for
                interior designers in California. CIDs demonstrate their education, experience, and
                examination expertise in California, reducing legal risks and boosting client
                confidence. They are accredited for professionalism, mandated to adhere to the{" "}
                <a href="https://ccidc.org/code-of-ethics/CCIDC" style={{ textDecoration: "none" }}>
            ...
            <>
              <ol type="a" style={{ marginLeft: 35 }}>
                <li>
                  ...
                  design documents. <span style={{ fontWeight: "bold" }}>NOT </span> architectural
                  or egineering ones.
                </li>
              </ol>
            </>
        ...
        <Accordion
          ...
          content={
            <>
              <p>
                The IDEX® California is a certification exam designed for Calfornia, focusing on
                the California Building Code (CBC), Title 24, ethics, buisness practices, and design
                ...
                layout and specifications, Contract documents, Contract administration, Buisness
                law, and Ethics. Please refer to this website for more information about the exam
                and to{" "}
        ...
        <Accordion
          ...
          content={
            <>
              <p>
                Once you login you will be directed to the Pre-Screening Questionnaire. This will
                help you assess what the right pathway is for you. You can retake the questionnaire
                as many times as you want to determine the right pathway for you.
              </p>
            </>
          }
        ></Accordion>
          ...
          content={
            <>
              <p>
                ...
                Practice of Design. Core units listed on the website are in terms of semester
                credits. Please divide quarter units by 1.5 to convert.
              </p>
            </>
          }
        ></Accordion>
        ...
        ></Accordion>
        <Accordion
          title="How much education do I need?"
          toggleAll={expandAllPathwaysInfo}
          content={
            <>
              <p>
          ...
          content={
            <>
              <p>
                ...
                non-seismic plans, providing instruction for their preparation, requiring the skills
                of a licensed contractor for implementation. It encompasses programming, planning,
                ...
                <br></br>
                <br></br>
                The full-time diversified design experience requirements are calculated by:<br></br>
                1 Year = 1,872 Hours+<br></br>2 Years = 3,744 Hours+<br></br>3 Years = 5,616 Hours+
                <br></br>4 Years = 7,488 Hours+<br></br>5 Years = 9,360 Hours+<br></br>8 Years =
                14,976 Hours+<br></br>
                <br></br>
              ...
              <ol className={styles.olist}>
                ...
                <li>
                  If <strong>not self-employed</strong>complete the Employment Verification Form
                  signed by both the candidate and employer, including a separate form for all
        ...
        ></Accordion>
        <Accordion
          title="Can international candidates apply?"
          toggleAll={expandAllPathwaysInfo}
          content={
            <>
              <ol type="a" style={{ marginLeft: 45 }}>
                <li>
                  All candidates who meet the qualifications are encouraged to become certified, as
